...
const Cards = ({ data }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-[14px] gap-y-4">
      {data.map((item, index) => (
        <div
          key={index}
          className="py-5 px-4 bg-[#fff] rounded-[12px] text-[#252525]"
        >
          <div className="flex gap-[13px] items-center mb-4">
            ...
            <div className="flex items-end gap-1.5">
              <div>
                ...
                <p className="leading-[1] text-[12px] font-medium">
                  {item.numbersAnalytics}
                </p>
              </div>

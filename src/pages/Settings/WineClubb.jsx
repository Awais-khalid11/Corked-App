...
const WineClubForm = () => {
 ...
 return (
  <div className="space-y-5">
    ...
    {/* ===== All Form Content: Club-Level + Tier-Level Fields ===== */}
    <div className="bg-white rounded-[12px] p-6 border border-gray-200 space-y-10">
      ...
      <div>
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2">
            ...
            <ImageUploadArea image={clubImage} onUpload={(e) => handleImageUpload(e)} id="club-image" />
          </div>
        </form>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-sm font-medium text-gray-500">Tier-Level Fields (repeatable):</h2>
